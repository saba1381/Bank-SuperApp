...
const CardTransferForm = ({ ownerName, initailCard, desCard, amount }) => {
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      if (!isTimerActive) {
        toast.error("ابتدا لطفا در خواست ارسال رمز پویا دهید.", {
          autoClose: 3000,
        });
        return;
      }
      ...
      >
        ...
        {bankInfo ? (
          ...
          >
            ...
            <Box sx={{ display: "flex", alignItems: "center" }}>
              ...
              {bankInfo.icon && (
                <img
                  src={bankInfo.icon.props.src}
                  alt={bankInfo.name}
                  width={bankInfo.iconWidth}
                  height={bankInfo.iconHeight}
                />
              )}
            </Box>
          </Box>
        ...
        >
          <TextField
            ...
            helperText={
              formik.touched.dynamicPassword && formik.errors.dynamicPassword
            }
            InputProps={{
              endAdornment: (
            ...
            InputLabelProps={{
              sx: {
                color: (theme) =>
                  theme.palette.mode === "dark" ? "navy" : "grey",
                "&.Mui-error": {
                  color: (theme) =>
                    theme.palette.mode === "dark"
                      ? "red !important"
                ...
                "&.Mui-focused": {
                  ...
                  "&.Mui-error": {
                    ...
                    "&.Mui-focused": {
                      color: (theme) =>
                        theme.palette.mode === "dark" ? "navy" : "#4f4f4f",
                      fontSize: {
                        xs: "1.01rem",
                        sm: "1.3rem",
                        md: "1.4rem",
                ...
                borderColor: (theme) =>
                  theme.palette.mode === "dark" ? "navy" : "grey.300",
                "&:hover": {
                  borderColor: (theme) =>
                    theme.palette.mode === "dark" ? "navy" : "grey.400",
                },
              },
            }}
            FormHelperTextProps={{
