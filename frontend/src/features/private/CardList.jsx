...
const CardList = ({ cards, onBack }) => {
    const [showAddCard, setShowAddCard] = useState(false); // Manage the state

    const handleAddCard = () => {
        setShowAddCard(true); // Show the AddCard component
    };

    const handleBackToList = () => {
        setShowAddCard(false); // Go back to the card list
    };
